...
// NormalScroll ...
var normalScroll = [][]int{{2, 7, 6, 9, 12, 5, 7, 8, 4, 10, 12, 6, 11, 8, 3, 7, 11, 1, 9, 12, 4, 7, 8, 5, 11, 10},
...
// RespinScroll1 RTP ...
var freeScroll = [][]int{{2, 7, 6, 9, 12, 2, 7, 8, 4, 10, 12, 6, 11, 8, 3, 7, 11, 1, 9, 12, 4, 7, 8, 5, 11, 10},
...
// FreeGameSetting 1 RTP:93, 2 RTP:96, 3 RTP:99
var FreeGameSetting = 1
...
var normalH5SpecialWinRate = []int{1, 2, 3, 5, 8, 10, 15, 30, 40}
var normalH5SpecialWinRateWeightings = []int{1116, 60, 30, 15, 8, 5, 3, 2, 1}

var freeGameSpinTime = []int{25, 20, 15, 13, 10, 6}
var freeGameWinRate = [][]int{
	{2, 3, 5},
	{3, 5, 8},
	{5, 8, 10},
	{8, 10, 15},
...
var freeGameWinRateWeightings = [][]int{
	{16, 4, 2},
	{80, 34, 10},
	{23, 10, 4},
	{65, 5, 2},
...
var freeH5SpecialWinRate = []int{50, 20, 15, 10, 5, 2}

var freeH5SpecialWinRateWeightings = [][]int{
	{3, 5, 12, 14, 15, 15},
	{3, 7, 11, 12, 15, 21},
	{3, 7, 13, 13, 19, 21},
	{1, 2, 4, 5, 18, 26},
...
// freeGameMysteryIndexCombination WinRate, Spin
var freeGameMysteryIndexCombination = [][]int{
...
var freeGameMysteryWeightings = []int{100, 76, 54, 46, 34, 20, 100, 100, 71, 60, 45, 30, 100, 100, 100, 85, 64, 40, 100, 100, 100, 100, 75, 44, 100, 100, 100, 100, 100, 53, 100, 100, 100, 100, 100, 100}
