...
import (
	...
	"gitlab.com/WeberverByGoGame7/foundation/myrestful"
	"gitlab.com/WeberverByGoGame7/gamerule"
	crontab "gitlab.com/WeberverByGoGame7/handlecrontab"
	db "gitlab.com/WeberverByGoGame7/handledb"
	event "gitlab.com/WeberverByGoGame7/handleevent"
	"gitlab.com/WeberverByGoGame7/serversetting"
	login "gitlab.com/WeberverByGoGame7/serviceaccount"
	game "gitlab.com/WeberverByGoGame7/servicegame"
	lobby "gitlab.com/WeberverByGoGame7/servicelobby"
	"gitlab.com/WeberverByGoGame7/servicethirdparty/api"
)
